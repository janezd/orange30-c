...
TM_YEAR, TM_MON, TM_DAY, TM_HOUR, TM_MIN, TM_SEC, TM_WDAY, TM_YDAY = list(range(8))
...
_rr = list(range(ord("A"), ord("Z")+1)) + list(range(ord("0"), ord("9")+1)) + list(range(ord("a"), ord("z")+1))
