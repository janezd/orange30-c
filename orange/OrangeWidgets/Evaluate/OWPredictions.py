...
def safe_call(func):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            # Qt for python 3 casts by itself 
...
class PyTableModel(QAbstractTableModel):
    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        if role == Qt.DisplayRole or role == Qt.EditRole:
            ...
            return None # QVariant() #QAbstractTableModel.data(self, index, role)
    ...
    def headerData(self, section, orientation, role=Qt.DisplayRole):
        if orientation == Qt.Vertical and  role == Qt.DisplayRole:
            return str(section+1) # QVariant(QString(str(section + 1)))
            ...
            return header # QVariant(QString(header)) if header is not None else QVariant()
        else:
            return None # QVariant() #QAbstractTableModel.headerData(self, section, orientation, role)
...
#                       callback=[self.updateTableOutcomes, self.checksendpredictions])
    ...
    def updateSpliter(self):
        ...
        def widthForColumns(view, start=-sys.maxsize, end=sys.maxsize):
            h_header = view.horizontalHeader()
            v_header = view.verticalHeader()
...
#            self.vheader.setLabel(i, self.table.item(i,0).text())
    ...
    def handleNewSignals(self):
        ...
        if self.data:
            ...
            self.setPredictionModel(list(self.predictors.values()), self.data)
    ...
    def setData(self, data):
        ...
        if not data:
            ...
            self.data = data
            self.rindx = list(range(len(self.data)))
    ...
    def setPredictor(self, predictor, id):
        ...
        ov = getoutvar(list(self.predictors.values()))
