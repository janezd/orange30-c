...
class OWMosaicOptimization(OWWidget, orngMosaic):
    ...
    def __init__(self, visualizationWidget = None, signalManager = None):
        ...
        self.attributeCountCombo = OWGUI.comboBox(self.buttonBox, self, "attributeCount", items = list(range(1, 5)), tooltip = "Evaluate only projections with exactly (or maximum) this number of attributes", sendSelectedValue = 1, valueType = int)
...
#        self.subsetTree.setColumnAlignment(1, QListView.AlignRight)
    ...
    def mtVisualizeMosaicTree(self):
        ...
        while treeDepth in itemsToDraw:
    ...
    def updateShownArguments(self):
        ...
        if classVal not in self.arguments: return
