...
#            self.dataA = data
        ...
        if self.dataA:
            self.varListA = list(self.dataA.domain.variables) + list(self.dataA.domain.getmetas().values())
        else:
            self.varListA = []
...
#            self.dataB = data
        ...
        if self.dataB:
            self.varListB = list(self.dataB.domain.variables) + list(self.dataB.domain.getmetas().values())
        else:
            self.varListB = []
...
#            self.send("Merged Examples B+A", None)
    ...
    def merge(self, dataA, dataB, varA, varB):
        ...
        metasA = list(dataA.domain.getmetas().items())
        metasB = list(dataB.domain.getmetas().items())
