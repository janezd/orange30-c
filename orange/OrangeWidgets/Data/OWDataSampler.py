...
class OWDataSampler(OWWidget):
    ...
    def __init__(self, parent=None, signalManager=None):
        ...
        # Output Group Box
        self.foldcombo = OWGUI.comboBox(self.controlArea, self, "outFold", 'Output Data for Fold / Group', 'Fold / group:', orientation = "horizontal", items = list(range(1,101)), callback = self.foldChanged, sendSelectedValue = 1, valueType = int)
