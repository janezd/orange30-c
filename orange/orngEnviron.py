...
def __getDirectoryNames():
    ...
    d = vars()
    return dict([(name, d[name]) for name in ["orangeDir", "orangeDocDir", "canvasDir", "widgetDir", "picsDir", "addOnsDirSys", "addOnsDirUser", "defaultReportsDir", "orangeSettingsDir", "widgetSettingsDir", "canvasSettingsDir", "bufferDir"]])
