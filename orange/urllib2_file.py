...
class newHTTPHandler(urllib.request.BaseHandler):
    ...
    def do_open(self, http_class, req):
        ...
        scheme, sel = urllib.parse.splittype(req.get_selector())
...
urllib2._old_HTTPHandler = urllib.request.HTTPHandler
urllib.request.HTTPHandler = newHTTPHandler

class newHTTPSHandler(newHTTPHandler):
    def https_open(self, req):
        return self.do_open(http.client.HTTPS, req)
    
urllib.request.HTTPSHandler = newHTTPSHandler
...
""" % progname)
    ...
    req = urllib.request.Request(v_url, data, {})
    try:
