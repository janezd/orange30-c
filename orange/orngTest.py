...
def leaveOneOut(learners, examples, pps=[], indicesrandseed="*", **argkw):
    ...
    return testWithIndices(learners, examples, list(range(len(examples))), indicesrandseed, pps, **argkw)
...
def learningCurveN(learners, examples, folds=10,
    ...
    return learningCurve(*(learners, examples, cv, pick, proportions, pps), **argkw)
